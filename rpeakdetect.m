function [Rpeak_Mat] = rpeakdetect(varargin)
%[Rpeak_Mat] = rpeakdetect(PeakLevel, sfq, ECG_dat, DisplayOption)
...
%
% Note:
%   - Original Matlab file: Rpeakfind
%   - Adding for ploting the signal (with grid on)
%
% Made by Amang Kim [v0.1 || 4/10/2019]
...
[a_m a_n]=size(Rpeak_Mat);
 ...
 if (a_m<MinofPeak)
    ...
    Rpeak_Mat=rpeakdetect(Peak_Rev, sfq, sig_dat,0);
 end
